...
class FeedForward(nn.Module):
    def __init__(self, dim, dim_out=None, mult=4, dropout=0.1, approximate: str = "none"): # dropout=0.0
        super().__init__()
...
class AttnProcessor:
    ...
    def __call__(
        ...
        x = F.scaled_dot_product_attention(query, key, value, attn_mask=attn_mask, dropout_p=0.1, is_causal=False) # dropout_p=0.0
...
class DiTBlock(nn.Module):
    def __init__(self, dim, heads, dim_head, ff_mult=4, dropout=0.2, qk_norm=None, pe_attn_head=None): #dopout 0.1 --> 0.5
        super().__init__()
...
class MMDiTBlock(nn.Module):
    ...
    def __init__(
        self, dim, heads, dim_head, ff_mult=4, dropout=0.2, context_dim=None, context_pre_only=False, qk_norm=None
    ): # dropout 0.1 --> -> 0.5
        super().__init__()
