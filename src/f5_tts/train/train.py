...
def main(model_cfg):
    ...
    if not hasattr(model_cfg, "reference_samples"):
        model_cfg.reference_samples = {}
        model_cfg.reference_samples.ref_audio_paths = []
        model_cfg.reference_samples.ref_texts = []
        model_cfg.reference_samples.ref_sample_text_prompts = []
    ...
    trainer = Trainer(
        ...
        weight_decay=model_cfg.optim.weight_decay,
        ...
        duration_loss_weight=model_cfg.duration_loss_weight,   
        # Add the new reference sample parameters
